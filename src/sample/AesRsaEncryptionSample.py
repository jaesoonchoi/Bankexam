...
PUB_KEY_LOC = "/home/deepal/Desktop/id_rsa.pub"
...
def startClient():
    ...
    _thread.start_new_thread(validation_server, (TCP_CON_PORT,))    # start the validation server in a seperate thread so that it runs seperately from the client
